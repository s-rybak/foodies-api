...
import authMiddleware, {notStrictAuthenticateMiddleware} from "../middlewares/authenticateMiddleware.js";
...
recipesRouter.get("/:id", notStrictAuthenticateMiddleware, getById);
